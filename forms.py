...
class OnboardingForm(FlaskForm):
    ...
    stripe_test_api_key = StringField('Test Stripe API Key', validators=[DataRequired()])
    stripe_live_api_key = StringField('Live Stripe API Key', validators=[DataRequired()])
